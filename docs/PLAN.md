...
| ITEM-006 | OL block-rank proxies, shared pace/injury, QB ADP out of ceiling | In Design | Spec: `docs/superpowers/specs/2026-08-11-ol-proxy-shared-factors-design.md`; Plan: `docs/superpowers/plans/2026-08-11-ol-proxy-shared-factors.md` — pressure/stuff pbp proxies; TE gets OL pass; WR/TE get `neutral_pace_rank`; QB gets DraftLab `injury_concern`, drops ceiling `adp` |

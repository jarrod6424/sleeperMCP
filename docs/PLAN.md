...
| ITEM-004 | RB receptions, YPC, YPT, team wins | In Review | `receptions`, `yards_per_carry`, `yards_per_touch` from nflverse weekly stats; `team_wins` from nflverse schedules; DraftLab `CEILING_KNOWN_FACTORS.RB` 11→15 — see `docs/superpowers/specs/2026-08-11-rb-yards-receptions-wins-design.md` |

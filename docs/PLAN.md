...
| ITEM-003 | WR ceiling factors | In Review | WR `qb_pff_rank` from nflverse ESPN QBR, `route_participation` from nflverse participation (FTN attribution), and `secondary_target` from nflverse receiving data; sleeperMCP artifacts regenerated 2026-08-11; DraftLab Task 5 pending — see `docs/superpowers/specs/2026-08-11-wr-ceiling-factors-design.md` |
